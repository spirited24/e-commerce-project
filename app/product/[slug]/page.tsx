        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="md:py-8">
            ...
            <div className=" flex gap-2.5">
                <AddToBag currency="usd" key={data._id} description={data.description} image={data.images[0]} name={data.name} price={data.price} price_id={data.price_id} 
                />
            ...
            <p className="mt-12 text-base text-gray-700 tracking-normal">
              {data.description}
            </p>
          </div>
        </div>
